...
export const testimonialsData = [
  {
    name: 'Siddharth Nair',
    role: 'IT Professional & F&O Trader',
    city: 'Bengaluru',
    broker: 'Zerodha Kite Connect',
    capital: '₹35,000 Allocation',
    rating: 4.5,
    tag: 'F&O Automation',
    content: 'Started with just ₹30,000 on my Zerodha account. What impressed me most was the live demo they gave me on live ticks before I paid a single rupee. The automated risk circuit breaker kept max drawdown well under control.',
  },
  {
    name: 'Vikram Joshi',
    ...
    capital: '₹50,000 Allocation',
    rating: 4.5,
    tag: 'Commodity & Cash',
    content: 'I don’t have time to look at charts during market hours. The non-custodial API execution means my money never leaves my broker account. Solid discipline and completely removed emotional manual mistakes.',
  },
  {
    name: 'Pooja Agarwal',
    ...
    city: 'Mumbai',
    broker: 'Dhan HQ',
    capital: '₹1.5 Lakh Allocation',
    rating: 5.0,
    tag: 'Strict VaR Management',
    content: 'The VaR risk limit of under ₹3,500 per trade is genuine. During severe Budget-day volatility, the algo executed timely hedges and protected profits. Clear email invoices and timely reports.',
  },
  {
    name: 'Ankit Mehta',
    role: 'Full-Time Retail Trader',
    city: 'Ahmedabad',
    broker: 'Upstox Developer API',
    capital: '₹75,000 Allocation',
    rating: 4.5,
    tag: 'Multi-Leg Options',
    content: 'Transitioned from manual discretionary trading to Algologic. The speed of execution on Bank Nifty straddles is sub-second. Seeing consistent green weeks without screen anxiety is a game changer.',
  },
  {
    name: 'Rajeev Menon',
    ...
    capital: '₹25,000 Allocation',
    rating: 4.0,
    tag: 'Zero Latency',
    content: 'Being an engineer, I audited their webhook execution speed and logic before subscribing. The architecture is pure modern quantitative engineering. Great transparency with no exaggerated false promises.',
  },
  {
    name: 'Sneha Deshmukh',
    ...
    city: 'Nagpur',
    broker: 'Zerodha Kite',
    capital: '₹1 Lakh Allocation',
    rating: 4.5,
    tag: 'Hands-Free Wealth',
    content: 'I have zero time during clinical hours to monitor Nifty candles. The algo handles entries, trailing stop-losses, and daily square-offs automatically. Onboarding took less than 15 minutes over Google Meet.',
  },
  {
    ...
    capital: '₹40,000 Allocation',
    rating: 4.0,
    tag: 'Equity Cash Momentum',
    content: 'Loved that they don’t demand huge capital to start. Deployed with ₹40,000 in Equity-Cash and Option buying strategies. The transparent live market demo gave me the confidence to subscribe.',
  },
  {
    name: 'Harish Verma',
    role: 'Consultant',
    ...
    capital: '₹2 Lakhs Allocation',
    rating: 4.5,
    tag: 'Drawdown Discipline',
    content: 'Most advisory services sell Telegram tips that fail. Algologic is a legitimate systematic software. The strict risk parity rules stop trading immediately once the daily target or risk limit is hit.',
  },
  {
    name: 'Manoj Patel',
    ...
    city: 'Surat',
    broker: 'Dhan API',
    capital: '₹5 Lakhs Allocation',
    rating: 5.0,
    tag: 'Automated Trailing SL',
    content: 'The dynamic trailing stop loss saved our positions during several sudden gap-downs. You get official emails from their registered ID for every transaction and package detail. 100% genuine desk.',
  },
  {
    name: 'Aditya Sen',
    ...
    capital: '₹80,000 Allocation',
    rating: 4.5,
    tag: 'Consistent Alpha',
    content: 'Subscribed under the Early Bird offer. Setup was completely seamless with encrypted API tokens. Their customer support over WhatsApp responded within 5 minutes whenever I had queries.',
  },
];
